$(document).ready(function () {
	...
	var paises = [
		...
		["Saint Lucia",	"LC"],
		["Saint-Martin (French part)",	"MF"],$(document).ready(function () {
	...
	for (var i = 0; i < paises.length; i++) {
		...
		$(".country-AG").append('<option value="'+codigo_pais+'">'+nombre_pais+'</option>');

		if( typeof selectpicker !== 'undefined' && jQuery.isFunction( selectpicker ) ) {
...
var estados = [
    ...
    $(".country-AG").change(function () {
       ...
       for (var i = estados.length - 1; i >= 0; i--) {
           if (estados[i][0] == codigo_pais) { 
                ...
                $(".state-AG").append('<option value="'+codigo_estado+'">'+nombre_estado+'</option>');   
                $('.state-AG').hide().show();
           }
       }
    ...
    $(".country-AG").change(function () {
        ...
        $('.state-AG').empty();
       var codigo_pais = $(".country-AG option:selected").val();
