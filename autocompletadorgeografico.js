...
for (var i = 0; i < paises.length; i++) {
	var nombre_pais = paises[i][0];
	var codigo_pais = paises[i][1];

	$("select.country-AG").append('<option value="'+codigo_pais+'">'+nombre_pais+'</option>');
}

if($('select.country-AG').hasClass("selectpicker")){
    $('select.country-AG').selectpicker('refresh');
}
...
var estados = [
    ...
    ["AO","Huambo","AO-HUA"],
    ["AO","Huila","AO-HUI"],
    ["AO","Kuando Kubango","AO-CCU"],
    ["AO","Kwanza Norte","AO-CNO"],
    ["AO","Kwanza Sul","AO-CUS"],
    ["AO","Luanda","AO-LUA"],
    ...
    ["BY","Hrodzenskaya voblasts'","BY-HR"],
    ...
    ["CD","Kinshasa","CD-KN"],
    ["CD","Kongo Central","CD-BC"],
    ["CD","Kwilu","CD-KL"],
    ["CD","Lualaba","CD-LU"],
    ["CD","Maniema","CD-MA"],
    ["CD","Nord-Kivu","CD-NK"],
    ["CD","Nord-Ubangi","CD-NU"],
    ["CD","Sankuru","CD-SA"],
    ["CD","Sud-Kivu","CD-SK"],
    ["CD","Sud-Ubangi","CD-SU"],
    ["CD","Tanganyika","CD-TA"],
    ...
    ["GT","Jutiapa","GT-JU"],
    ["GT","Peten","GT-PE"],
    ["GT","Quetzaltenango","GT-QZ"],
    ["GT","Quiche","GT-QC"],
    ["GT","Retalhuleu","GT-RE"],
    ["GT","Sacatepequez","GT-SA"],
    ["GT","San Marcos","GT-SM"],
    ["GT","Santa Rosa","GT-SR"],
    ["GT","Solola","GT-SO"],
    ["GT","Suchitepequez","GT-SU"],
    ["GT","Totonicapan","GT-TO"],
    ["GT","Zacapa","GT-ZA"],
    ["GU","Agat","-"],
    ["GU","Asan-Maina","-"],
    ["GU","Barrigada","-"],
    ...
    ["IR","Alborz","IR-32"],
    ["IR","Ardabil","IR-03"],
    ["IR","Azarbayjan-e Gharbi","IR-02"],
    ["IR","Azarbayjan-e Sharqi","IR-01"],
    ["IR","Bushehr","IR-06"],
    ["IR","Chahar Mahal va Bakhtiari","IR-08"],
    ["IR","Esfahan","IR-04"],
    ["IR","Fars","IR-14"],
    ["IR","Gilan","IR-19"],
    ["IR","Golestan","IR-27"],
    ...
    ["IR","Khorasan-e Razavi","IR-30"],
    ["IR","Khorasan-e Shomali","IR-31"],
    ["IR","Khuzestan","IR-10"],
    ["IR","Kohgiluyeh va Bowyer Ahmad","IR-18"],
    ["IR","Kordestan","IR-16"],
    ["IR","Lorestan","IR-20"],
    ["IR","Markazi","IR-22"],
    ["IR","Mazandaran","IR-21"],
    ...
    ["IR","Qom","IR-26"],
    ["IR","Semnan","IR-12"],
    ["IR","Sistan va Baluchestan","IR-13"],
    ["IR","Tehran","IR-07"],
    ["IR","Yazd","IR-25"],
    ["IR","Zanjan","IR-11"],
    ["IS","Austurland","IS-7"],
    ...
    ["KH","Kracheh","KH-10"],
    ["KH","Krong Kaeb","KH-23"],
    ["KH","Krong Pailin","KH-24"],
    ["KH","Krong Preah Sihanouk","KH-18"],
    ...
    ["LV","Aglonas novads","LV-001"],
    ["LV","Aizkraukles novads","LV-002"],
    ["LV","Aizputes novads","LV-003"],
    ["LV","Alojas novads","LV-005"],
    ["LV","Aluksnes novads","LV-007"],
    ["LV","Babites novads","LV-012"],
    ["LV","Baldones novads","LV-013"],
    ["LV","Baltinavas novads","LV-014"],
    ["LV","Balvu novads","LV-015"],
    ["LV","Bauskas novads","LV-016"],
    ["LV","Beverinas novads","LV-017"],
    ["LV","Brocenu novads","LV-018"],
    ["LV","Carnikavas novads","LV-020"],
    ["LV","Cesu novads","LV-022"],
    ["LV","Cesvaines novads","LV-021"],
    ["LV","Ciblas novads","LV-023"],
    ["LV","Daugavpils novads","LV-025"],
    ["LV","Dobeles novads","LV-026"],
    ["LV","Erglu novads","LV-030"],
    ["LV","Gulbenes novads","LV-033"],
    ["LV","Iecavas novads","LV-034"],
    ["LV","Ikskiles novads","LV-035"],
    ["LV","Incukalna novads","LV-037"],
    ["LV","Jaunjelgavas novads","LV-038"],
    ["LV","Jaunpiebalgas novads","LV-039"],
    ["LV","Jaunpils novads","LV-040"],
    ["LV","Jekabpils novads","LV-042"],
    ["LV","Jelgava","LV-JEL"],
    ["LV","Jelgavas novads","LV-041"],
    ["LV","Jurmala","LV-JUR"],
    ["LV","Kekavas novads","LV-052"],
    ["LV","Kokneses novads","LV-046"],
    ["LV","Kraslavas novads","LV-047"],
    ["LV","Kuldigas novads","LV-050"],
    ["LV","Lielvardes novads","LV-053"],
    ["LV","Liepaja","LV-LPX"],
    ["LV","Limbazu novads","LV-054"],
    ["LV","Livanu novads","LV-056"],
    ["LV","Lubanas novads","LV-057"],
    ["LV","Ludzas novads","LV-058"],
    ["LV","Madonas novads","LV-059"],
    ["LV","Malpils novads","LV-061"],
    ["LV","Nauksenu novads","LV-064"],
    ["LV","Ogres novads","LV-067"],
    ["LV","Olaines novads","LV-068"],
    ["LV","Ozolnieku novads","LV-069"],
    ["LV","Preilu novads","LV-073"],
    ["LV","Rezeknes novads","LV-077"],
    ["LV","Riebinu novads","LV-078"],
    ["LV","Riga","LV-RIX"],
    ["LV","Rojas novads","LV-079"],
    ["LV","Ropazu novads","LV-080"],
    ["LV","Rugaju novads","LV-082"],
    ["LV","Rundales novads","LV-083"],
    ["LV","Salaspils novads","LV-087"],
    ["LV","Saldus novads","LV-088"],
    ["LV","Saulkrastu novads","LV-089"],
    ["LV","Sejas novads","LV-090"],
    ["LV","Siguldas novads","LV-091"],
    ["LV","Skrundas novads","LV-093"],
    ["LV","Stopinu novads","LV-095"],
    ["LV","Talsu novads","LV-097"],
    ["LV","Tukuma novads","LV-099"],
    ["LV","Valkas novads","LV-101"],
    ["LV","Valmiera","LV-VMR"],
    ["LV","Vecumnieku novads","LV-105"],
    ...
    ["MK","Bosilovo","MK-07"],
    ["MK","Brvenica","MK-08"],
    ["MK","Centar Zupa","MK-78"],
    ["MK","Cesinovo-Oblesevo","MK-81"],
    ["MK","Cucer Sandevo","MK-82"],
    ["MK","Debar","MK-21"],
    ["MK","Debarca","MK-22"],
    ["MK","Delcevo","MK-23"],
    ["MK","Demir Hisar","MK-25"],
    ["MK","Demir Kapija","MK-24"],
    ["MK","Dojran","MK-26"],
    ["MK","Dolneni","MK-27"],
    ["MK","Gevgelija","MK-18"],
    ["MK","Gostivar","MK-19"],
    ...
    ["MK","Kocani","MK-42"],
    ["MK","Kratovo","MK-43"],
    ["MK","Kriva Palanka","MK-44"],
    ["MK","Krusevo","MK-46"],
    ["MK","Kumanovo","MK-47"],
    ["MK","Lipkovo","MK-48"],
    ["MK","Lozovo","MK-49"],
    ["MK","Makedonska Kamenica","MK-51"],
    ["MK","Makedonski Brod","MK-52"],
    ["MK","Mavrovo i Rostusa","MK-50"],
    ["MK","Negotino","MK-54"],
    ["MK","Novo Selo","MK-56"],
    ["MK","Ohrid","MK-58"],
    ["MK","Pehcevo","MK-60"],
    ...
    ["MK","Struga","MK-72"],
    ["MK","Strumica","MK-73"],
    ["MK","Studenicani","MK-74"],
    ["MK","Sveti Nikole","MK-69"],
    ["MK","Tearce","MK-75"],
    ["MK","Tetovo","MK-76"],
    ["MK","Valandovo","MK-10"],
    ["MK","Veles","MK-13"],
    ...
    ["PK","Punjab","PK-PB"],
    ["PK","Sindh","PK-SD"],
    ["PL","Dolnoslaskie","PL-DS"],
    ["PL","Kujawsko-pomorskie","PL-KP"],
    ["PL","Lodzkie","PL-LD"],
    ["PL","Lubelskie","PL-LU"],
    ["PL","Lubuskie","PL-LB"],
    ["PL","Malopolskie","PL-MA"],
    ["PL","Mazowieckie","PL-MZ"],
    ["PL","Opolskie","PL-OP"],
    ["PL","Podkarpackie","PL-PK"],
    ["PL","Podlaskie","PL-PD"],
    ["PL","Pomorskie","PL-PM"],
    ["PL","Slaskie","PL-SL"],
    ["PL","Swietokrzyskie","PL-SK"],
    ["PL","Warminsko-mazurskie","PL-WN"],
    ["PL","Wielkopolskie","PL-WP"],
    ["PL","Zachodniopomorskie","PL-ZP"],
    ...
    ["TD","Guera","TD-GR"],
    ["TD","Hadjer Lamis","TD-HL"],
    ["TD","Logone-Occidental","TD-LO"],
    ["TD","Mayo-Kebbi-Est","TD-ME"],
    ["TD","Ouaddai","TD-OD"],
    ["TD","Tibesti","TD-TI"],
...
$("select.country-AG").change(function () {

	$('select.state-AG').empty();
	document.getElementsByClassName('state-AG').selectedIndex = 0;

	var show_select_estado = 0;
	var codigo_pais = $(this).val();

	for (var i = estados.length - 1; i >= 0; i--) {
	   if (estados[i][0] == codigo_pais) { 

		show_select_estado = 1;

		var codigo_estado = estados[i][2];
		var nombre_estado = estados[i][1];
		var codigo_pais = estados[i][0];

		$("select.state-AG").append('<option value="'+codigo_estado+'">'+nombre_estado+'</option>');
	   }
	   //$('select.state-AG').selectpicker('render');
	}

	if($('select.state-AG').hasClass("selectpicker")){
	   $('select.state-AG').selectpicker('refresh');
	}

	if (show_select_estado == 1) {
	    $('.state-AG').prop("disabled", false);
	    $('.state-AG').prop("hidden", false);    
	}else{
	    $('.state-AG').prop("disabled", true);
	    //$('.state-AG').prop("hidden", true); 
	    $('.state-AG').prop("required", false); 
	}
});

   var monedas = [
        ["MQ", "EUR", "euro"],
        ["AF", "AFN", "afgani afgano"],
        ["ZA", "ZAR", "rand sudafricano"],
        ["AL", "ALL", "lek albanés"],
        ["DE", "EUR", "euro"],
        ["AD", "EUR", "euro"],
        ["AO", "AOA", "kwanza angoleño"],
        ["AI", "XCD", "dólar"],
        ["AG", "XCD", "dólar"],
        ["AN", "ANG", "florín antillano neerlandés"],
        ["SA", "SAR", "riyal saudí"],
        ["DZ", "DZD", "dinar algerino"],
        ["AR", "ARS", "peso argentino"],
        ["AM", "AMD", "dram armenio"],
        ["AW", "AWG", "florín arubeño"],
        ["AU", "AUD", "dólar australiano"],
        ["AT", "EUR", "euro"],
        ["AZ", "AZN", "manat azerbaiyano"],
        ["BS", "BSD", "dólar bahameño"],
        ["BH", "BHD", "dinar bahreini"],
        ["BD", "BDT", "taka"],
        ["BB", "BBD", "dólar"],
        ["BE", "EUR", "euro"],
        ["BZ", "BZD", "dólar"],
        ...
        ["BM", "BMD", "dólar"],
        ["BT", "BTN", "ngultrum"],
        ["BY", "BYN", "rublo bielorruso"],
        ["MM", "MMK", "kyat birmano"],
        ["BO", "BOB", "boliviano"],
        ["BA", "BAM", "marco convertible"],
        ["BW", "BWP", "pula"],
        ["BR", "BRL", "real brasileño"],
        ["BN", "BND", "dólar"],
        ["BG", "BGN", "lev búlgaro"],
        ["BF", "XOF", "franco CFA"],
        ["BI", "BIF", "franco burundés"],
        ["CV", "CVE", "escudo caboverdiano"],
        ["KH", "KHR", "riel camboyano"],
        ["CM", "XAF", "franco CFA"],
        ["CA", "CAD", "dólar canadiense"],
        ["TD", "XAF", "franco CFA"],
        ["CL", "CLP", "peso chileno"],
        ["CN", "CNY", "RMB yuan renminbi chino"],
        ["CY", "EUR", "euro"],
        ["VA", "EUR", "euro"],
        ["CO", "COP", "peso colombiano"],
        ["KM", "KMF", "franco comoriano"],
        ["CG", "XAF", "franco CFA"],
        ["CD", "CDF", "franco congoleño"],
        ["KP", "KPW", "won norcoreano"],
        ["KR", "KRW", "won surcoreano"],
        ["CI", "XOF", "franco CFA"],
        ["CR", "CRC", "colón costarricense"],
        ["HR", "HRK", "kuna croata"],
        ["CU", "CUC", "peso cubano convertible"],
        ["DK", "DKK", "corona danesa"],
        ["DM", "XCD", "dólar"],
        ["EC", "USD", "dólar estadounidense"],
        ["EG", "EGP", "libra egipcia"],
        ["AE", "AED", "dirham"],
        ["ER", "ERN", "nafka eritreo"],
        ["SK", "EUR", "euro"],
        ["SI", "EUR", "euro"],
        ["ES", "EUR", "euro"],
        ...
        ["RU", "RUB", "rublo ruso"],
        ["GA", "XAF", "franco CFA"],
        ["GM", "GMD", "dalasi gambiano"],
        ["GE", "GEL", "lari georgiano"],
        ["GH", "GHS", "cedi ghanés"],
        ["GI", "GIP", "libra"],
        ["UK", "GBP", "libra esterlina"],
        ["GR", "EUR", "euro"],
        ["GD", "XCD", "dólar"],
        ["GL", "DKK", "corona danesa"],
        ["GP", "EUR", "euro"],
        ["GU", "USD", "dólar estadounidense"],
        ["GT", "GTQ", "quetzal guatemalteco"],
        ["GY", "GYD", "dólar guyanés"],
        ["GG", "GGP", "libra"],
        ["GF", "EUR", "euro"],
        ["GN", "GNF", "franco guineano"],
        ["GW", "XAF", "franco CFA"],
        ["HT", "HTG", "gourde haitiano"],
        ["NL", "EUR", "euro"],
        ["HN", "HNL", "lempira hondureño"],
        ["HK", "HKD", "dólar"],
        ...
        ["IE", "EUR", "euro"],
        ["IM", "IMP", "libra"],
        ["CX", "AUD", "dólar australiano"],
        ["MU", "MUR", "rupia mauricia"],
        ["IS", "ISK", "Króna islandesa"],
        ["KY", "KYD", "dólar caimano"],
        ["CC", "AUD", "dólar australiano"],
        ["CK", "NZD", "dólar neozelandés"],
        ["MP", "USD", "dólar estadounidense"],
        ["FO", "DKK", "corona danesa"],
        ["HM", "AUD", "dólar australiano"],
        ["MH", "USD", "dólar estadounidense"],
        ["SB", "SBD", "dólar"],
        ["VG", "USD", "dólar estadounidense"],
        ["VI", "USD", "dólar estadounidense"],
        ["IL", "ILS", "nuevo shékel israeli"],
        ["IT", "EUR", "euro"],
        ["JM", "JMD", "dólar jamaicano"],
        ["JP", "JPY", "yen japonés"],
        ["JE", "JEP", "libra"],
        ["JO", "JOD", "dinar jordano"],
        ["KZ", "KZT", "tenge kazajo"],
        ["KE", "KES", "chelín keniata"],
        ["KG", "KGS", "som kirguís"],
        ["KI", "KID", "dólar de Kiribati"],
        ["KW", "KWD", "dinar kuwaití"],
        ["RE", "EUR", "euro"],
        ["LA", "LAK", "kip lao"],
        ["LS", "LSL", "loti lesotense"],
        ["LV", "EUR", "euro"],
        ["LB", "LBP", "libra libanesa"],
        ["LR", "LRD", "dólar liberiano"],
        ["LY", "LYD", "dinar libio"],
        ["LI", "CHF", "franco suizo"],
        ["LT", "LTL", "litas lituano"],
        ["LU", "EUR", "euro"],
        ["MO", "MOP", "pataca"],
        ["MK", "MKD", "denar macedonio"],
        ["MG", "MGA", "ariary malgache"],
        ["MY", "MYR", "ringgit malayo"],
        ["MW", "MWK", "kwacha malauí"],
        ["MV", "MVR", "rufiyaa maldiva"],
        ["ML", "XOF", "franco CFA"],
        ["MT", "EUR", "euro"],
        ["MA", "MAD", "dirham marroquí"],
        ["MR", "MRU", "ouguiya mauritana"],
        ["YT", "EUR", "euro"],
        ["MX", "MXN", "peso mexicano"],
        ["FM", "USD", "dólar estadounidense"],
        ["MD", "MDL", "leu moldavo"],
        ["MC", "EUR", "euro"],
        ["MN", "MNT", "tughrik mongol"],
        ["ME", "EUR", "euro"],
        ["MS", "XCD", "dólar"],
        ["MZ", "MZN", "metical mozambiqueño"],
        ["NA", "NAD", "dólar namibio"],
        ["NR", "AUD", "dólar australiano"],
        ["NP", "NPR", "rupia nepalesa"],
        ["NI", "NIO", "córdoba nicaragüense"],
        ["NE", "XOF", "franco CFA"],
        ["NG", "NGN", "naira nigeriana"],
        ["NU", "NZD", "dólar neozelandés"],
        ["NF", "AUD", "dólar australiano"],
        ["NO", "NOK", "corona noruega"],
        ["NC", "XPF", "franco CFP"],
        ["NZ", "NZD", "dólar neozelandés"],
        ["OM", "OMR", "rial omaní"],
        ["PK", "PKR", "rupia pakistaní"],
        ["PW", "USD", "dólar estadounidense"],
        ["PS", "ILS", "nuevo shékel israeli"],
        ["PA", "PAB", "balboa panameña"],
        ["PG", "PGK", "kina"],
        ["PY", "PYG", "guaraní"],
        ["PE", "PEN", "nuevo sol peruano"],
        ["PN", "NZD", "dólar neozelandés"],
        ["PF", "XPF", "franco CFP"],
        ["PL", "PLN", "złoty polaco"],
        ["PT", "EUR", "euro"],
        ["PR", "USD", "dólar estadounidense"],
        ["QA", "QAR", "rial qatarí"],
        ["CF", "XAF", "franco CFA"],
        ["CS", "CZK", "Koruna checa"],
        ["DO", "DOP", "peso dominicano"],
        ["RW", "RWF", "franco ruandés"],
        ["RO", "RON", "leu rumano"],
        ["RU", "RUB", "rublo ruso"],
        ["EH", "MAD", "dirham marroquí"],
        ["SV", "SVC", "colón"],
        ["AS", "USD", "dólar estadounidense"],
        ["WS", "WST", "tala samoana"],
        ["KN", "XCD", "dólar"],
        ["SM", "EUR", "euro"],
        ["PM", "EUR", "euro"],
        ...
        ["SL", "SLL", "leone"],
        ["SG", "SGD", "dólar"],
        ["SX", "ANG", "florín antillano neerlandés"],
        ["SY", "SYP", "libra siria"],
        ["SO", "SOS", "chelín somalí"],
        ["LK", "LKR", "rupia"],
        ["SD", "SDG", "dinar sudanés"],
        ["SS", "SSP", "South Sudanese Pound"],
        ["SE", "SEK", "corona sueca"],
        ["CH", "CHF", "franco suizo"],
        ["SR", "SRD", "dólar surinamés"],
        ["SJ", "NOK", "corona noruega"],
        ["SZ", "SZL", "lilangeni suazi"],
        ["TH", "THB", "baht tailandés"],
        ["TW", "TWD", "nuevo dólar taiwanés"],
        ["TZ", "TZS", "chelín tanzano"],
        ["TJ", "TJS", "somoni tayik"],
        ["IO", "GBP", "libra esterlina"],
        ["TL", "USD", "dólar estadounidense"],
        ["TG", "XOF", "franco CFA"],
        ["TK", "NZD", "dólar neozelandés"],
        ["TO", "TOP", "pa'anga tongano"],
        ["TT", "TTD", "dólar"],
        ["TN", "TND", "dinar tunecino"],
        ["TM", "TMT", "manat turcomano"],
        ["TR", "TRY", "nueva lira"],
        ["TC", "USD", "dólar estadounidense"],
        ["TV", "AUD", "dólar australiano"],
        ["UA", "UAH", "grivna ucrainiana"],
        ["UG", "UGX", "chelín ugandés"],
        ["EU", "EUR", "euro"],
        ["UY", "UYU", "peso uruguayo"],
        ["UZ", "UZS", "som uzbeko"],
        ["VU", "VUV", "vatu vanuatense"],
        ["UM", "USD", "dólar estadounidense"],
        ["VE", "VES", "bolívar soberano"],
        ["VN", "VND", "dong vietnamito"],
        ["WF", "XPF", "franco CFP"],
        ["YE", "YER", "rial yemeni"],
        ["DJ", "DJF", "franco yibutiano"],
        ["YU", "YUN", "dinar yugoslavo"],
        ["ZM", "ZMW", "kwacha zambiano"],
        ["ZW", "ZWL", "dólar zimbabuense"]
    ];
    


    $("select.country-AG").change(function () {
        $('select.currency-AG').val("");
        $('select.currency_code-AG').val("");
	    
        var codigo_pais = $(this).val();
	    
       for (var i = monedas.length - 1; i >= 0; i--) {
           if (monedas[i][0] == codigo_pais) { 
                
                var codigo_moneda = monedas[i][1];
                var nombre_moneda = monedas[i][2];
               
                $('.currency-AG').val(nombre_moneda);
                $('.currency_code-AG').val(codigo_moneda);
           }
       }
    });
});
