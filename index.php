<?php require("select_paises.php"); ?>

<select 
  class="  form-control select_estado" 
  data-live-search="true" 
  data-live-search-normalize="true"
  title="-- Estates --"
  name="select_estado_registro"  autocomplete="estados" required style="width: 100%;" hidden="hidden">  
</select>


<input type="text" class="tipo_moneda form-control" readonly="readonly"  style="width: 100%;" >
<input type="text" name="tipo_moneda" class="tipo_moneda_codigo"  readonly="readonly">
 ...
 $(document).ready(function () {
            ...
            $(".select_pais").change(function () {
                ...
                $('.select_estado').empty();
               var codigo_pais = $(".select_pais option:selected").val();
               ...
               for (var i = estados.length - 1; i >= 0; i--) {
                   if (estados[i][0] == codigo_pais) { 
                        ...
                        $(".select_estado").append('<option value="'+codigo_estado+'">'+nombre_estado+'</option>');   
                        $('.select_estado').hide().show();
                   }
               }

                if (show_select_estado == 1) {
                    $('.select_estado').prop("disabled", false);
                    $('.select_estado').prop("hidden", false);    
                }else{
                    $('.select_estado').prop("disabled", true);
                    $('.select_estado').prop("hidden", true); 
                }
    ...
    $(".select_pais").change(function () {
       ...
       for (var i = monedas.length - 1; i >= 0; i--) {
           if (monedas[i][0] == codigo_pais) { 
                ...
                $('.tipo_moneda').val(nombre_moneda);
                $('.tipo_moneda_codigo').val(codigo_moneda);
           }
       }
